...
syn match   javascriptCtor             "\<\u\w\+\>\.\@!"
syn match   javascriptConst            "\<[A-Z_]\+\>"
...
syntax match   javaScriptCtor           /\<\u\w\+\>\.\@!/
syntax match   javaScriptConst          /\<[A-Z_]\+\>/
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptStringD              StringD
  ...
  HiLink javascriptCtor                 Ctor
  HiLink javaScriptConst                Constant
